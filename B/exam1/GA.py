...
class GA():
    ...
    def initPopulation(self):
        ...
        for i in range(self.Population_Count):
            ...
            gene1=random.sample(gene[1:],self.BUSNUM)
            gene1.insert(0,0)
            city=City(gene1)
    ...
    def cross(self,parent1,parent2):
        index1=random.randint(0,self.BUSNUM-1)
        index2=random.randint(index1,self.BUSNUM-1)
    ...
    def variation(self,gene):
        index1=random.randint(0,self.BUSNUM-1)
        index2=random.randint(0,self.BUSNUM-1)
